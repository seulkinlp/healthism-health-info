...
## 2026-07-18
- 완료: collect_mkhealth.py 작성 (idxno 순회, figure 제거, 결번 스킵, 구간 인자)
- 검증: idxno 60000~60020 시험 수집 13건 성공, 빈 본문/날짜 0건, 캡션 제거 정상
- 확인: 섹션 목록 페이지는 495페이지(idxno 약 41000, 2018~19년)가 바닥 → 2015~18은 idxno 순회 필수
- 함정: 목록 페이지는 마지막 페이지 초과 시 1페이지로 되돌아감(500~1000 모두 최신기사) → 페이지 순회 시 중복 감지 필수
- 발견: 매경헬스 기사 중 건강 관련은 약 40%, 나머지는 기업 홍보·유통 기사 → 사후 분류 필수
- 다음: ① 섹션 목록(S2N46) 순회로 '건강·질병 idxno 정답 집합' 수집 ② 이를 기준으로 사후 분류 규칙 개발·검증
